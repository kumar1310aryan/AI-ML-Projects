...
label_title = tk.Label(frame1, text="Video Surveillance and Detection")
...
btn2 = tk.Button(frame1, text='Test', height=90, width=180, fg='orange', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
